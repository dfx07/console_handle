...
protected:
	bool CreateConsoleFont()
	{
		...
		m_hFont = ::CreateFontA(m_nFontSize, 0, 0, 0, m_dwFontType, FALSE, FALSE, FALSE,
...
public:
	...
	virtual bool LoadFont(const char* font_name, unsigned int font_size, ConsoleFontType font_type)
	{
	...
	virtual std::string GetFontName() noexcept
	{
